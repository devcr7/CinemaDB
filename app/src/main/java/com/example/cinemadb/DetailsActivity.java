...
import com.example.cinemadb.Adapters.CastRecyclerAdapter;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_movie_released=findViewById(R.id.textView_released);
        textView_movie_runtime=findViewById(R.id.textView_runtime);
        textView_movie_rating=findViewById(R.id.textView_rating);
        textView_movie_votes=findViewById(R.id.textView_votes);
